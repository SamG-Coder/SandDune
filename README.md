...
- **Fish:** press **6**, then click or hold inside the box to drop flowing-fin goldfish from above (about three per second). The Fish limit slider allows 1–64 fish, with a live count; lowering it stops further additions without deleting existing fish. Each fish has its own size, colours and irregular markings. They fall under gravity, swim with smooth turns and neighbour avoidance when their full body fits in the water, and loosely shoal with neighbours. Hunger triggers short bottom-grazing bouts. On sand they wriggle toward nearby water; in shallows they paddle toward deeper areas. After 15 continuous simulation seconds without water covering their gills, they die and fade over three seconds, freeing a population slot. Getting their gills back underwater before death resets the timer. Water depth is an oxygen proxy, not a dissolved-oxygen simulation; pausing also pauses survival time. Reset sand clears fish.
